    ...
    return (
      ...
      <Dropdown className="dropdown">
        ...
        <Dropdown.Menu className="shadow">
          <Dropdown.Item href="#/dashboard" className="d-flex align-items-center">
            <svg width="18" height="18" viewBox="0 0 18 18" fill="currentColor" xmlns="http://www.w3.org/2000/svg" className="me-2">
          ...
          <Dropdown.Item href="#/messages" className="d-flex align-items-center">
            <svg width="22" height="21" viewBox="0 0 22 21" fill="currentColor" xmlns="http://www.w3.org/2000/svg" className="me-2">
          ...
          <Dropdown.Item href="#/job-alerts" className="d-flex align-items-center">
            <svg stroke="currentColor" fill="none" strokeWidth="2" viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round" className="me-2" height="1em" width="1em">
          ...
          <Dropdown.Item href="#/manage-resumes" className="d-flex align-items-center">
            <svg stroke="currentColor" fill="none" strokeWidth="2" viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round" className="me-2" height="1em" width="1em">
          ...
          <Dropdown.Item href="#/my-profile" className="d-flex align-items-center">
            <svg width="18" height="20" viewBox="0 0 18 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg" className="me-2">
          ...
          <Dropdown.Item href="#/log-out" className="d-flex align-items-center">
            <svg stroke="currentColor" fill="none" strokeWidth="2" viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round" className="me-2" height="1em" width="1em">
