...
const Sidebar = () => {
    return (
        <div className="sidebar d-flex flex-column">
            <NavLink to="/dashboard" className="sidebar-item dd">
            ...
            <NavLink to="/dashboard/messages" className="sidebar-item">
            ...
            <NavLink to="/dashboard/manage-resumes" className="sidebar-item">
            ...
            <NavLink to="/dashboard/add-resumes" className="sidebar-item">
            ...
            <NavLink to="/dashboard/my-profile" className="sidebar-item">
            ...
            <NavLink to="/" className="sidebar-item sidebar-item-l">
                <svg stroke="currentColor" fill="none" strokeWidth="2" viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round" className="me-3 text-primary" height="1em" width="1em">
